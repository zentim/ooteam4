...
/**
 * 
 * Test Chain Of Responsibility Pattern and Strategy Pattern (Need to connect
 * mysql)
 *
 */
public class DiscountTest {
    ...
    @Test
    public void testNationHolidayDiscount() throws Exception {
        System.out.println();
        ...
        promotionitem.setProduct((Product) productdao.get(productId));
        promotionitem.setMinQuantity(2);
        promotionitem.setDiscountOf(0);
        int promotionItemIdX = promotionitemdao.add(promotionitem);

        // create promotionitem "gets 1 unit of Product X (or Product Y) free on
        // national holidays"
        promotionitem = new PromotionItem();
        promotionitem.setPromotion((Promotion) promotiondao.get(promotionId));
        promotionitem.setProduct((Product) productdao.get(productId));
    ...
    @Test
    public void testLastYear100KDiscount() throws Exception {
        System.out.println();
        ...
        // create promotionitem "has brought in the last year more than $100K, he gets a
        // 20% discount"
        promotionitem = new PromotionItem();
        promotionitem.setPromotion((Promotion) promotiondao.get(promotionId));
        promotionitem.setProduct((Product) productdao.get(productId));
    ...
    @Test
    public void testEachGroupOf100Discount() throws Exception {
        System.out.println();
    ...
    @Test
    public void testXYZDiscount() throws Exception {
        System.out.println();
        ...
        // create promotionitem "buys Product X, Product Y and Product Z he gets a
        // discount of 5%"
        promotionitem = new PromotionItem();
        promotionitem.setPromotion((Promotion) promotiondao.get(promotionId));
        promotionitem.setMinQuantity(1);
        ...
        int promotionItemIdY = promotionitemdao.add(promotionitem);
        promotionitem.setProduct((Product) productdao.get(productIdZ));
        ...
        orderitem.setOriginalPrice(((Product) productdao.get(productIdX)).getPrice());
        orderitem.setPromotionalPrice(((Product) productdao.get(productIdX)).getPrice());
        orderitem.setProduct((Product) productdao.get(productIdX));
        int orderItemIdX = orderitemdao.add(orderitem);

        orderitem.setOriginalPrice(((Product) productdao.get(productIdY)).getPrice());
        orderitem.setPromotionalPrice(((Product) productdao.get(productIdY)).getPrice());
        orderitem.setProduct((Product) productdao.get(productIdY));
        int orderItemIdY = orderitemdao.add(orderitem);

        orderitem.setOriginalPrice(((Product) productdao.get(productIdZ)).getPrice());
        orderitem.setPromotionalPrice(((Product) productdao.get(productIdZ)).getPrice());
        orderitem.setProduct((Product) productdao.get(productIdZ));
